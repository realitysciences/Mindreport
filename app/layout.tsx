        ...
        <footer style={{ borderTop: '1px solid var(--border)', background: 'var(--surface)' }}>
          ...
          <div className="px-8 py-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between text-sm" style={{ color: 'var(--text-faint)', fontFamily: 'var(--font-mono)' }}>
            ...
            <div className="flex items-center gap-4">
              <a href="https://x.com/mindreportai" target="_blank" rel="noopener noreferrer" className="transition-opacity hover:opacity-70" style={{ color: 'var(--text-faint)' }} aria-label="X / Twitter">
